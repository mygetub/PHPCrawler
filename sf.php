<?php
	...
	$config = array(
		...
		'name' => 'articles',
		// 入口url
		'url' => 'https://segmentfault.com/t/nginx/blogs',
		//解析器
		//Reg:正则表达式解析器
		//Xpath：xpath解析器
		...
		'rule' => array(
			...
			array(
				'name'=>'content',
				'selector' => '/<div class="article fmt article__content".*?>.*?<\/div>/ism',
		...
		'first' => array(
			array(
				'selector' => '//*[@id="blog"]/section[$id]/div[2]/h2/a/@href'
			)
		),
